...
public class HeadControl : MonoBehaviour
{
    ...
    public List<Vector3> posList = new List<Vector3>();  //头的位置列表
    ...
    void RandomFood()
    {
        ...
        cc.GetComponent<Renderer>().material.color = Color.green;
        //改变食物的颜色
    }
    ...
    void CreatBody()
    {
        ...
        newBody.GetComponent<FollowMovement>().bodyID = score;                 //将分数设置成身体结点编号
